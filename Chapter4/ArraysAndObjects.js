...
//adding new property for CHF which is 1.1787
rates.CHF = 1.1787

console.log(rates.CHF)
//code to get exchange rates for all the different countries
console.log(rates)
//calculate the euros in Australian dollars
console.log(100 * rates.AUD)

//code to identify the highest exchange rate compared to euros
rates = findMax(1.5417, 1.9588, 3.8959, 1.5194);
function findMax() {
  var i;
  var max = -Infinity;
...
//Print Gary Oldmans cats name
for (let i=1; i < 2; i++) {
    console.log(cats_and_owners[1]['cat']);
}
//Add Taylor Swift and her cat 'Meredith' to the array
var newArray = {name: "Taylor Swift", cat: "Meredith"}
cats_and_owners.push(newArray);

//write a loop to print each cat owner and their cat name
